...
var scores, roundScore, player, activePlayer, player1Score, dicePictures, gamePlaying;
...
var initDice = document.querySelector('.btn-new');
...
if (gamePlaying) {
  ...
  initDice.addEventListener('click', init);
}
